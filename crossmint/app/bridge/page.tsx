...
export default function BridgePage() {
  ...
  // ---- Fetch a bridge quote from Relay ----
  ...
  const executeBridge = useCallback(async () => {
    ...
    try {
      ...
      // For a native ETH bridge, there's typically a single "deposit" step
      // with one transaction item containing the calldata from Relay.
    ...
    <div className="mx-auto max-w-2xl px-4 py-16">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold">Bridge ETH</h1>
        </div>
